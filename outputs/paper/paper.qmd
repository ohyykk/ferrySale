...
@fig-linePlot3 below compares the sales count and redemption count in year 2021 and 2023. The two side-by-side plots illustrate distinct usage patterns across these years. 
...
#| warning: false
#| message: false
#| fig-pos: "H"  # Fix the plot in current place when rendered
#| fig-width: 8
#| fig-height: 3
